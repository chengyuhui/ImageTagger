...
(function() {
  ...
  }).option('-r, --recursive', 'Include files in subdirectories', function() {
    return cliconfig.recursive = true;
  ...
  program.command('pixiv [dir]').description('Tag images from pixiv.').action(function(env) {
